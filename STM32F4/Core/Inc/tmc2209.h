...
typedef struct
{
  ...
  uint16_t                 hardware_enable_pin_;
  UART_HandleTypeDef 	   uart_;
  GPIO_TypeDef*			   hardware_enable_gpio_port_;
  uint8_t                  toff_;
...
/**
 * @brief Set the uart for the stepper driver.
 *
 * @param stepper_driver
 * @param uart
 */
void tmc2209_set_uart(tmc2209_stepper_driver_t *stepper_driver, UART_HandleTypeDef uart) __attribute__((weak));
 ...
 */
void tmc2209_set_hardware_enable_pin(tmc2209_stepper_driver_t *stepper_driver, uint16_t hardware_enable_pin, GPIO_TypeDef* hardware_enable_gpio_port_) __attribute__((weak));
/**
